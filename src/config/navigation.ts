...
export const mainNavItems = [
  ...
  },
  {
    ...
    icon: GitCompare,
    label: "Match CV",
    featureKey: navFeatures.MATCH_CV,
  }, // New navigation item
  { to: "/travel", icon: Map, label: "Travel", featureKey: navFeatures.TRAVEL },
  {
    ...
    icon: Send,
    label: "Contact",
    featureKey: navFeatures.CONTACT,
  },
];
...
export const managementNavItems = [
  {
    ...
    icon: Newspaper,
    label: "Manage Blog",
    featureKey: navFeatures.MANAGE_BLOG,
  },
  {
    to: "/manage-gallery",
    icon: ImageIcon,
    label: "Manage Gallery",
    featureKey: navFeatures.MANAGE_GALLERY,
  },
  {
    to: "/manage-travel",
    icon: Map,
    label: "Manage Travel",
    featureKey: navFeatures.MANAGE_TRAVEL,
  },
  {
    to: "/feature-toggles",
    icon: ToggleRight,
    label: "Feature Toggles",
    featureKey: navFeatures.FEATURE_TOGGLES,
  },
];
