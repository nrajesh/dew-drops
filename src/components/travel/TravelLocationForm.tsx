...
const locationSchema = z.object({
  ...
  name: z
    .string()
    .min(3, { message: "Place name must be at least 3 characters." }),
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {editingLocation
            ? "Update the details for this travel location."
            : "Add a new pin to your travel map. Coordinates are optional."}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="A short description of your visit."
                      {...field}
                      value={field.value ?? ""}
                    />
                  </FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col">
                  ...
                  <Popover
                    open={blogPopoverOpen}
                    onOpenChange={setBlogPopoverOpen}
                  >
