...
interface PublishedImageListItemProps {
  image: GalleryImage;
  isSelected: boolean;
...
export const PublishedImageListItem = ({ image, isSelected, onSelect, onTogglePublish, onEdit, onView, isBulkActionMode }: PublishedImageListItemProps) => {
