    ...
    if (editingPost) {
      form.reset({
        ...
        published_at: editingPost.published_at
          ? editingPost.published_at.split("T")[0]
      ...
      <CardHeader>
        ...
        <CardDescription>
          {editingPost
            ...
            : "Create a new article. You can use Markdown for the content."}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Search your gallery by title or tags.
                    </FormDescription>
                    <FormControl>
                      <CoverImagePicker
                ...
                render={({ field }) => {
                  ...
                  return (
                    <FormItem>
                      ...
                      <FormDescription>
                        Paste a YouTube URL or video ID — ID auto-extracted.
                      </FormDescription>
                      <FormControl>
                        <Input
                      ...
                      {thumb && (
                        <img
                          src={thumb}
                          alt="YouTube preview"
                          className="mt-1 rounded w-full aspect-video object-cover"
                        />
                      )}
                      <FormMessage />
                    </FormItem>
