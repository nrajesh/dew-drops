...
import { calculateWeightedMatchPercentage } from "@/utils/cosineSimilarity"; // Corrected import
...
const Chat = ({ jobDescription, onClose }: ChatProps) => {
  ...
  const { chatbotKnowledge, resume, loading: contextLoading, error: contextError } = usePortfolioContext(); // Corrected destructuring
